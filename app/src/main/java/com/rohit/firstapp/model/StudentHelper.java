...
public class StudentHelper extends SQLiteOpenHelper {
    ...
    {
        String data[]={StudentContact.ID,StudentContact.NAME,StudentContact.AGE,
                        StudentContact.ADDRESS,StudentContact.BRANCH};
        Cursor cursor=db.query(StudentContact.TABLE_NAME,data,null,
                null,null,null,StudentContact.NAME);
        return  cursor;
    }
